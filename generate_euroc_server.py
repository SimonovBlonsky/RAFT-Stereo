...
euroc_root = "/mnt/nas_8/datasets/EuRoC/data"
output_root = "/mnt/nas_9/group/chenguyuan/EuRoC_depth_2"
euroc_scenes = [
    #"MH_01_easy",
    #"MH_02_easy",
    #"MH_03_medium",
...
def demo(args):
    ...
    for scene in tqdm(sorted(euroc_scenes)):
        output_directory = output_root + '/' + scene
        output_directory = Path(output_directory)
        output_directory.mkdir(exist_ok=True)
        
        left_imgs = osp.join(euroc_root, scene, 'mav0/cam0/data/*.png')
        right_imgs = osp.join(euroc_root, scene, 'mav0/cam1/data/*.png')
        ...
        with torch.no_grad():
            ...
            if len(left_images) != len(right_images):
                print(f"Warning. Cam0 has {len(left_images)} but cam1 has {len(right_images)}. Please check your timestamps.")
